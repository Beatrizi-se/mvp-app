...
class _TaskFormPageState extends State<TaskFormPage> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            const Text('P', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black87, fontSize: 24)),
            Image.asset('assets/pato_logo.png', height: 30),
            const Text('TO', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black87, fontSize: 24)),
          ],
        ),
        centerTitle: true,
        actions: [
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFieldLabel('Título da tarefa', count: "${_titleController.text.length}/100"),
            ...
            _buildFieldLabel('Descrição (opcional)', count: "${_descController.text.length}/300"),
            _buildCustomTextField(
            ...
            Row(
              children: [
                Expanded(child: _buildSelector('Categoria', 'Selecione', Icons.book_outlined)),
                const SizedBox(width: 16),
                Expanded(child: _buildSelector('Prioridade', 'Normal', Icons.flag_outlined, iconColor: Colors.amber)),
              ],
            ),
            ...
            Row(
              children: [
                Expanded(child: _buildSelector('Data', 'Definir data', Icons.calendar_today_outlined)),
                const SizedBox(width: 16),
                Expanded(child: _buildSelector('Horário (opcional)', 'Definir horário', Icons.access_time)),
              ],
            ),
              ...
              Padding(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: GoogleFonts.poppins(color: Colors.black26, fontSize: 14),
                  ),
                ),
              )
            else
              ..._steps.map((step) => TaskStepItem(
                text: step,
                onDelete: () {
                  setState(() {
                    _steps.remove(step);
  ...
  Widget _buildSelector(String label, String value, IconData icon, {Color? iconColor}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            child: const Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Text('Gerar passos com IA', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold)),
                SizedBox(width: 4),
